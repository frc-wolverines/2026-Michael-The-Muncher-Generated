...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(new CurrentLimitsConfigs().withStatorCurrentLimit(65).withStatorCurrentLimitEnable(true));
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.4560546875);
